...
export default {
  ...
  theme: {
    // Radius diwariskan 0px di semua tempat kecuali 'pill' — DESIGN.md §rounded
    borderRadius: {
      none: '0px',
      xs: '2px',
      sm: '4px',
    ...
    extend: {
      colors: {
        // DESIGN.md §colors — diwariskan persis, tidak diubah
        primary: '#0f62fe',
        'on-primary': '#ffffff',
        ink: '#161616',
        'ink-muted': '#525252',
      ...
      fontSize: {
        ...
        'mono-data': ['14px', { lineHeight: '1.40', letterSpacing: '0.16px', fontWeight: '400' }],
      },
      spacing: {
        xxs: '4px',
        xs: '8px',
